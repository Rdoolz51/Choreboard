      ...
      <div className="container container--chores p-0">
        <div className="cb-tabs--chores">
          <button
            className={
              tabSelected === 1
                ? "tabs--chores active-tabs--chores tab-1--chores noBorder--chores"
                : "tabs--chores noBorder--chores"
            }
            onClick={() => toggleTab(1)}
          >
            To-Do
          ...
          <button
            className={
              tabSelected === 2
                ? "tabs--chores active-tabs--chores tab-2--chores noBorder--chores"
                : "tabs--chores noBorder--chores"
            }
            onClick={() => toggleTab(2)}
          >
          ...
          <Button
            ...
            className={
              tabSelected === 1
                ? "rightNav--chores addChoreBtn--chores"
                : " rightNav--chores addChoreBtn--chores disableBtn--chores"
            }
            onClick={handleShow}
          >
            + Add Chore
